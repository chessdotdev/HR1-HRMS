...
<head>
    ...
    <title>Register — HR Portal</title>
...
<div class="register-card">
    <div class="register-header">
      <img src="./assets/image/hrms-logo-transparent.png" class="register-logo">
        <h1 class="register-title">Create an account</h1>
        <p class="register-subtitle">Register to apply for job openings</p>
    </div>
